...
from src.megapose.datasets.samplers import DistributedSceneSampler
from src.megapose.datasets.scene_dataset import SceneDataset, SceneObservation
...
from src.megapose.utils.distributed import get_rank, get_tmp_dir, get_world_size
...
class PredictionRunner:
    ...
    def run_inference_pipeline(
        ...
        if self.inference_cfg.coarse_estimation_type == "external":
            ...
            coarse_estimates = megapose.inference.utils.add_instance_id(
                coarse_estimates
            )
