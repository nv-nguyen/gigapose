...
# MegaPose
from src.megapose.config import (
    BOP_DS_DIR,
    BOP_PANDA3D_DS_DIR,
    GSO_DIR,
    LOCAL_DATA_DIR,
...
from src.megapose.datasets.bop_object_datasets import BOPObjectDataset
from src.megapose.datasets.bop_scene_dataset import BOPDataset, remap_bop_targets
from src.megapose.datasets.deepim_modelnet import DeepImModelNetDataset
from src.megapose.datasets.gso_dataset import GoogleScannedObjectDataset
from src.megapose.datasets.modelnet_object_dataset import ModelNetObjectDataset
from src.megapose.datasets.object_dataset import RigidObjectDataset
from src.megapose.datasets.scene_dataset import SceneDataset
from src.megapose.datasets.shapenet_object_dataset import ShapeNetObjectDataset
from src.megapose.datasets.urdf_dataset import UrdfDataset
from src.megapose.datasets.web_scene_dataset import WebSceneDataset
