...
# MegaPose
from src.megapose.config import DEBUG_DATA_DIR
from src.megapose.inference.depth_refiner import DepthRefiner
from src.megapose.inference.refiner_utils import compute_masks
from src.megapose.inference.types import PoseEstimatesType
...
def get_normal(
    depth_refine, fx=-1, fy=-1, cx=-1, cy=-1, bbox=np.array([0]), refine=True
):
