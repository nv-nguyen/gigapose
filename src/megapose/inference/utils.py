...
from src.megapose.inference.detector import Detector
from src.megapose.inference.types import DetectionsType, PoseEstimatesType
...
from src.megapose.training.detector_models_cfg import (
    check_update_config as check_update_config_detector,
)
from src.megapose.training.detector_models_cfg import create_model_detector
