...
from src.megapose.datasets.bop import BOPDataset
from src.megapose.datasets.gso_dataset import GoogleScannedObjectDataset, make_gso_infos
from src.megapose.datasets.hdf5_scene_dataset import write_scene_ds_as_hdf5
from src.megapose.datasets.shapenet_object_dataset import (
    ShapeNetObjectDataset,
    make_shapenet_infos,
)
from src.megapose.datasets.web_scene_dataset import write_scene_ds_as_wds
from src.megapose.utils.distributed import get_rank, get_tmp_dir, init_distributed_mode
...
def make_script(output_dir, objects, textures, cfg, seed):
    ...
    modules += [
        ...
        make_light_sampler(
            radius_min=cfg.light_radius_min, radius_max=cfg.light_radius_max
        ),
        make_camera_sampler(
...
def make_one_scene_script(cfg, output_dir, seed):
    ...
    script["seed"] = seed
    scene_infos = dict(
        objects=objects, floor_textures=this_scene_floor_textures, seed=seed
    )
