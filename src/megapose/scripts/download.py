...
# MegaPose
from src.megapose.config import LOCAL_DATA_DIR, PROJECT_DIR
...
def main():
    ...
    if args.data_object_models:
        ...
        subprocess.run(
            ["unzip", LOCAL_DATA_DIR / "tars/shapenetcorev2.zip", LOCAL_DATA_DIR]
        )
        subprocess.run(
            [
                "unzip",
                LOCAL_DATA_DIR / "tars/google_scanned_objects.zip",
                LOCAL_DATA_DIR,
            ]
        )
