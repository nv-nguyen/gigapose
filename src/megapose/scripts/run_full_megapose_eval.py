...
# MegaPose
import src.megapose.evaluation.bop
import src.megapose.evaluation.evaluation
from src.megapose.bop_config import (
    PBR_COARSE,
    PBR_DETECTORS,
    PBR_REFINER,
    SYNT_REAL_COARSE,
...
from src.megapose.evaluation.eval_config import (
    BOPEvalConfig,
    EvalConfig,
    FullEvalConfig,
    HardwareConfig,
)
from src.megapose.evaluation.evaluation import generate_save_key, run_eval
