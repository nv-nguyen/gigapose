...
# MegaPose
from src.megapose.datasets.pose_dataset import BatchPoseData
from src.megapose.lib3d.camera_geometry import (
    project_points_robust as project_points_robust,
)
from src.megapose.lib3d.cosypose_ops import (
...
from src.megapose.lib3d.rigid_mesh_database import BatchedMeshes
from src.megapose.lib3d.transform_ops import add_noise, invert_transform_matrices
from src.megapose.models.pose_rigid import PosePredictor
from src.megapose.training.training_config import TrainingConfig
from src.megapose.training.utils import cast, cast_images
...
def megapose_forward_loss(
    ...
    if make_visualization:
        ...
        images_crop = images_crop.view(
            batch_size, n_hypotheses, *images_crop.shape[-3:]
        )
            ...
            for view_idx in range(n_views):
                ...
                for init_idx in range(n_hypotheses):
                    ...
                    ref_point_uv = project_points_robust(
                        points_orig, KV_crop_, TCR_
                    ).flatten()
                    origin_uv = project_points_robust(
                        points_orig, KV_crop_, TCO_
                    ).flatten()
