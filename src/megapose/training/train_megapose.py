...
# MegaPose
from src.megapose.config import EXP_DIR
from src.megapose.datasets.datasets_cfg import make_object_dataset, make_scene_dataset
from src.megapose.datasets.object_dataset import (
    RigidObjectDataset,
    concat_object_datasets,
)
from src.megapose.datasets.pose_dataset import PoseDataset
...
from src.megapose.datasets.web_scene_dataset import (
...
from src.megapose.training.megapose_forward_loss import megapose_forward_loss
from src.megapose.training.pose_models_cfg import check_update_config, create_model_pose
from src.megapose.training.training_config import DatasetConfig, TrainingConfig
from src.megapose.training.utils import (
    CudaTimer,
    make_lr_ratio_function,
    make_optimizer,
    write_logs,
)
from src.megapose.utils.distributed import (
    get_rank,
    get_world_size,
...
from src.megapose.utils.logging import get_logger
from src.megapose.utils.random import get_unique_seed, set_seed, temp_numpy_seed
from src.megapose.utils.resources import (
    get_cuda_memory,
    get_gpu_memory,
    get_total_memory,
)
...
def train_megapose(cfg: TrainingConfig) -> None:
    ...
    lr_scheduler = torch.optim.lr_scheduler.LambdaLR(
        optimizer, make_lr_ratio_function(cfg)
    )
    ...
    for epoch in range(start_epoch, cfg.n_epochs + 1):
        ...
        if cfg.add_iteration_epoch_interval is None:
            ...
            n_iterations = min(
                epoch // cfg.add_iteration_epoch_interval + 1, cfg.n_iterations
            )
